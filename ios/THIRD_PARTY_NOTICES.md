...
## PhotoStack interaction model

The native SwiftUI multi-photo stack is adapted from the interaction model and
design measurements published by Wren036's PhotoStack project.
